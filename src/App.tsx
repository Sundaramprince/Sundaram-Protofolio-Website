...
export default function App() {
  ...
  return (
    <div className="bg-dark-bg min-h-screen text-white font-sans selection:bg-neon-blue/30 overflow-x-hidden relative">
      ...
      {/* Scroll Progress Bar */}
      <motion.div
        className="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-neon-blue to-neon-purple origin-left z-[100]"
        style={{ scaleX }}
      />
